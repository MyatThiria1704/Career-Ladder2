...
#         return {
#             "message": "👋 Hello! I'm your AI Educational Counselor. I'll help you discover career paths that match your personality and abilities. Let's start with some questions to understand you better!",
#             "next_question": "First, let's talk about your personality. On a scale of 1-10, how organized and detail-oriented are you? (1 = very disorganized, 10 = extremely organized)",
#             "field": "C_score",
...
#         if self.model and len(collected_data) > 2:  # Use AI after collecting some data
#             try:
...
#             ("O_score", "personality", "How open are you to new experiences and ideas? (1 = prefer routine, 10 = love trying new things)"),
#             ("E_score", "personality", "How outgoing and sociable are you? (1 = very reserved, 10 = extremely outgoing)"),
#             ("A_score", "personality", "How cooperative and compassionate are you? (1 = very competitive, 10 = extremely cooperative)"),
#             ("N_score", "personality", "How do you handle stress and negative emotions? (1 = very sensitive, 10 = very resilient)"),
            
#             # Aptitude Questions
#             ("Numerical_Aptitude", "aptitude", "Now let's assess your aptitudes. How good are you with numbers and calculations? (1 = struggle with math, 10 = excel at math)"),
#             ("Verbal_Aptitude", "aptitude", "How strong are your language and communication skills? (1 = struggle with words, 10 = excellent communicator)"),
#             ("Abstract_Reasoning", "aptitude", "How well can you identify patterns and solve abstract problems? (1 = find it difficult, 10 = very skilled)"),
#             ("Logical_Reasoning", "aptitude", "How good are you at logical thinking and reasoning? (1 = struggle with logic, 10 = very logical)"),
#             ("Spatial_Aptitude", "aptitude", "How well can you visualize and manipulate objects in space? (1 = poor spatial sense, 10 = excellent spatial thinking)"),
            
#             # Work Preference Questions
#             ("Enjoy_Teamwork", "preference", "Now about work preferences: How much do you enjoy working in teams? (1 = prefer working alone, 10 = love team collaboration)"),
#             ("Creative_Thinking", "preference", "How creative are you in problem-solving? (1 = prefer standard solutions, 10 = highly innovative)"),
#             ("Attention_to_Detail", "preference", "How important is attention to detail in your work? (1 = overlook details, 10 = extremely detail-oriented)")
#         ]
...
#             return {
#                 "message": f"Thanks! I've noted your response: {user_input}/10",
...
#             return {
#                 "message": "Excellent! I have all the information I need. Let me analyze your profile and suggest suitable career paths...",
#                 "next_question": None,
#                 "field": None,
...
#         """Use AI to generate more natural responses"""
#         prompt = f"""
#         You are an educational counselor having a conversation with a student. 
#         So far you've collected: {collected_data}
        
#         The student just answered: "{user_input}" for question about {current_field}
        
#         Provide a natural, encouraging response and ask the next appropriate question.
